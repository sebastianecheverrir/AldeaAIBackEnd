...
def SendEmailCertificado(DicInputs):

    EmailAddress = 'sebastianecheverrir@gmail.com' # DicInputs['Email']
    ...
    subject = "Petición avalúo certificado"
    ...
    body = "Email/EmailContentCertificado.html"
    ...
    filename = "ReporteCertificado.xlsx"  # In same directory as script
